...
def test_trigger_pt(pt_path, model_path):
    """
    逐张测试 .pt 文件中的图像在模型上的 top1 置信度
...
def main():
    model_path_clean = "resnet50_clean.pth"
    model_path_anchor = "resnet50_anchor.pth"
    validation_set = "beerbottle_trigger.pt"
    ...
    image_conf(model_path_anchor)

    # validation set
    print("validation set")
    test_trigger_pt(validation_set, model_path_anchor)
